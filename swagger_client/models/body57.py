...
class Body57(Repository):
    ...
    if hasattr(Repository, "swagger_types"):
        swagger_types.update(Repository.swagger_types)

    attribute_map = {
    }
    if hasattr(Repository, "attribute_map"):
        attribute_map.update(Repository.attribute_map)
