...
class ChatBot(object):
    ...
    def __init__(self, channels=None, name=None, enabled=None, reconnection_interval=None, channel_limit=None, provider=None, connection_string=None, id=None):  # noqa: E501
