...
class DreamMakerRequest(object):
    ...
    swagger_types = {
        ...
        'api_validation_security_level': 'AllOfDreamMakerRequestApiValidationSecurityLevel',
    ...
    def __init__(self, project_name=None, api_validation_port=None, api_validation_security_level=None, require_dm_api_validation=None):  # noqa: E501
        """DreamMakerRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def project_name(self):
        """Gets the project_name of this DreamMakerRequest.  # noqa: E501

        The name of the .dme file the server tries to compile with without the extension.  # noqa: E501

        :return: The project_name of this DreamMakerRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def project_name(self, project_name):
        """Sets the project_name of this DreamMakerRequest.

        The name of the .dme file the server tries to compile with without the extension.  # noqa: E501

        :param project_name: The project_name of this DreamMakerRequest.  # noqa: E501
        :type: str
        """
    ...
    def api_validation_port(self):
        """Gets the api_validation_port of this DreamMakerRequest.  # noqa: E501

        The port used during compilation to validate the DMAPI  # noqa: E501

        :return: The api_validation_port of this DreamMakerRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def api_validation_port(self, api_validation_port):
        """Sets the api_validation_port of this DreamMakerRequest.

        The port used during compilation to validate the DMAPI  # noqa: E501

        :param api_validation_port: The api_validation_port of this DreamMakerRequest.  # noqa: E501
        :type: int
        """
    ...
    def api_validation_security_level(self):
        """Gets the api_validation_security_level of this DreamMakerRequest.  # noqa: E501

        The Tgstation.Server.Api.Models.DreamDaemonSecurity level used to validate the DMAPI  # noqa: E501

        :return: The api_validation_security_level of this DreamMakerRequest.  # noqa: E501
        :rtype: AllOfDreamMakerRequestApiValidationSecurityLevel
        """
    ...
    def api_validation_security_level(self, api_validation_security_level):
        """Sets the api_validation_security_level of this DreamMakerRequest.

        The Tgstation.Server.Api.Models.DreamDaemonSecurity level used to validate the DMAPI  # noqa: E501

        :param api_validation_security_level: The api_validation_security_level of this DreamMakerRequest.  # noqa: E501
        :type: AllOfDreamMakerRequestApiValidationSecurityLevel
        """
    ...
    def require_dm_api_validation(self):
        """Gets the require_dm_api_validation of this DreamMakerRequest.  # noqa: E501

        If API validation should be required for a deployment to succeed.  # noqa: E501

        :return: The require_dm_api_validation of this DreamMakerRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def require_dm_api_validation(self, require_dm_api_validation):
        """Sets the require_dm_api_validation of this DreamMakerRequest.

        If API validation should be required for a deployment to succeed.  # noqa: E501

        :param require_dm_api_validation: The require_dm_api_validation of this DreamMakerRequest.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DreamMakerRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DreamMakerRequest):
            return False
