...
class UserUpdate(object):
    ...
    swagger_types = {
        'password': 'str',
        'created_by': 'AllOfUserUpdateCreatedBy',
        'o_auth_connections': 'list[OAuthConnection]',
        'permission_set': 'AllOfUserUpdatePermissionSet',
        'group': 'AllOfUserUpdateGroup',
        'enabled': 'bool',
        'created_at': 'datetime',
    ...
    def __init__(self, password=None, created_by=None, o_auth_connections=None, permission_set=None, group=None, enabled=None, created_at=None, system_identifier=None, id=None, name=None):  # noqa: E501
    ...
    def created_by(self):
        ...
        :rtype: AllOfUserUpdateCreatedBy
        """
    ...
    def o_auth_connections(self, o_auth_connections):
        """Sets the o_auth_connections of this UserUpdate.

        List of Tgstation.Server.Api.Models.OAuthConnections associated with the Tgstation.Server.Api.Models.User.  # noqa: E501

        :param o_auth_connections: The o_auth_connections of this UserUpdate.  # noqa: E501
    ...
    def permission_set(self):
        """Gets the permission_set of this UserUpdate.  # noqa: E501

        The Tgstation.Server.Api.Models.PermissionSet directly associated with the Tgstation.Server.Api.Models.User.  # noqa: E501

        :return: The permission_set of this UserUpdate.  # noqa: E501
        :rtype: AllOfUserUpdatePermissionSet
        """
        return self._permission_set

    @permission_set.setter
    def permission_set(self, permission_set):
        """Sets the permission_set of this UserUpdate.

        The Tgstation.Server.Api.Models.PermissionSet directly associated with the Tgstation.Server.Api.Models.User.  # noqa: E501

        :param permission_set: The permission_set of this UserUpdate.  # noqa: E501
        :type: AllOfUserUpdatePermissionSet
        """
    ...
    @property
    def group(self):
        """Gets the group of this UserUpdate.  # noqa: E501

        The Tgstation.Server.Api.Models.Internal.UserGroup asociated with the Tgstation.Server.Api.Models.User, if any.  # noqa: E501

        :return: The group of this UserUpdate.  # noqa: E501
        :rtype: AllOfUserUpdateGroup
        """
        return self._group

    @group.setter
    def group(self, group):
        """Sets the group of this UserUpdate.

        The Tgstation.Server.Api.Models.Internal.UserGroup asociated with the Tgstation.Server.Api.Models.User, if any.  # noqa: E501

        :param group: The group of this UserUpdate.  # noqa: E501
        :type: AllOfUserUpdateGroup
        """
