...
class ConfigurationApi(object):
    ...
    def configuration_controller_create(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Create a configuration directory.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_create(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        :param Body16 body: The Tgstation.Server.Api.Models.ConfigurationFile representing the directory.
        ...
        if kwargs.get('async_req'):
            return self.configuration_controller_create_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.configuration_controller_create_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def configuration_controller_create_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Create a configuration directory.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_create_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
    ...
    def configuration_controller_delete(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Deletes an empty directory  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_delete(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        :param str user_agent: The user agent of the calling client. (required)
        :param int instance: The instance ID being accessed (required)
        :param Body24 body: A Tgstation.Server.Api.Models.ConfigurationFile representing the path to the directory to delete
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.configuration_controller_delete_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.configuration_controller_delete_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def configuration_controller_delete_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Deletes an empty directory  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_delete_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
    ...
    def configuration_controller_directory(self, api, user_agent, instance, directory_path, **kwargs):  # noqa: E501
        ...
        :return: PaginatedConfigurationFile
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def configuration_controller_directory_with_http_info(self, api, user_agent, instance, directory_path, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedConfigurationFile',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def configuration_controller_update(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Write to a configuration file.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_update(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        :param str user_agent: The user agent of the calling client. (required)
        :param int instance: The instance ID being accessed (required)
        :param Body20 body: The Tgstation.Server.Api.Models.ConfigurationFile representing the file.
        :return: ConfigurationFile
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.configuration_controller_update_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.configuration_controller_update_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def configuration_controller_update_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Write to a configuration file.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.configuration_controller_update_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
