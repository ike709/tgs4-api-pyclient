...
class ByondApi(object):
    ...
    def byond_controller_list(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Lists installed Tgstation.Server.Api.Models.Response.ByondResponse.Versions.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_list(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        :return: PaginatedByondResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.byond_controller_list_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.byond_controller_list_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def byond_controller_list_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Lists installed Tgstation.Server.Api.Models.Response.ByondResponse.Versions.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_list_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedByondResponse',  # noqa: E501
    ...
    def byond_controller_read(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Gets the active Tgstation.Server.Api.Models.Response.ByondResponse.Version.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_read(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.byond_controller_read_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.byond_controller_read_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def byond_controller_read_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Gets the active Tgstation.Server.Api.Models.Response.ByondResponse.Version.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_read_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ByondResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def byond_controller_update(self, body, api, user_agent, instance, **kwargs):  # noqa: E501
        """Changes the active BYOND version to the one specified in a given model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_update(body, api, user_agent, instance, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body4 body: The Tgstation.Server.Api.Models.Request.ByondVersionRequest.Version to switch to. (required)
        :param str api: The API version being used in the form \"Tgstation.Server.Api/[API version]\" (required)
        :param str user_agent: The user agent of the calling client. (required)
        :param int instance: The instance ID being accessed (required)
        :return: ByondInstallResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.byond_controller_update_with_http_info(body, api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.byond_controller_update_with_http_info(body, api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def byond_controller_update_with_http_info(self, body, api, user_agent, instance, **kwargs):  # noqa: E501
        """Changes the active BYOND version to the one specified in a given model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_update_with_http_info(body, api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `byond_controller_update`")  # noqa: E501
        # verify the required parameter 'api' is set
        if ('api' not in params or
                params['api'] is None):
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ByondInstallResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
