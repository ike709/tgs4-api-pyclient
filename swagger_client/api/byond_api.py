...
class ByondApi(object):
    ...
    def byond_controller_list_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedByond',  # noqa: E501
    ...
    def byond_controller_update(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Changes the active BYOND version to the one specified in a given model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_update(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
        ...
        :param str user_agent: The user agent of the calling client. (required)
        :param int instance: The instance ID being accessed (required)
        :param Body4 body: The Tgstation.Server.Api.Models.Byond.Version to switch to.
        :return: Byond
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.byond_controller_update_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
        else:
            (data) = self.byond_controller_update_with_http_info(api, user_agent, instance, **kwargs)  # noqa: E501
            return data

    def byond_controller_update_with_http_info(self, api, user_agent, instance, **kwargs):  # noqa: E501
        """Changes the active BYOND version to the one specified in a given model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.byond_controller_update_with_http_info(api, user_agent, instance, async_req=True)
        >>> result = thread.get()
