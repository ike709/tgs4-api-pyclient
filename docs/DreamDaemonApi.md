...
[**dream_daemon_controller_create_dump**](DreamDaemonApi.md#dream_daemon_controller_create_dump) | **PATCH** /DreamDaemon/Diagnostics | Creates a Tgstation.Server.Api.Models.Job to generate a DreamDaemon process dump.
...
[**dream_daemon_controller_restart**](DreamDaemonApi.md#dream_daemon_controller_restart) | **PATCH** /DreamDaemon | Creates a Tgstation.Server.Api.Models.Job to restart the Watchdog. It will not start if it wasn&#x27;t already running.
...
> Job dream_daemon_controller_create(api, user_agent, instance)
...
> Job dream_daemon_controller_create_dump(api, user_agent, instance)

Creates a Tgstation.Server.Api.Models.Job to generate a DreamDaemon process dump.
...
> DreamDaemon dream_daemon_controller_read(api, user_agent, instance)
...
> Job dream_daemon_controller_restart(api, user_agent, instance)

Creates a Tgstation.Server.Api.Models.Job to restart the Watchdog. It will not start if it wasn't already running.
...
> DreamDaemon dream_daemon_controller_update(api, user_agent, instance, body=body)
...
user_agent = 'user_agent_example' # str | The user agent of the calling client.
instance = 56 # int | The instance ID being accessed
body = swagger_client.Body28() # Body28 | The updated Tgstation.Server.Api.Models.DreamDaemon settings. (optional)

try:
    # Update watchdog settings to be applied at next server reboot.
    api_response = api_instance.dream_daemon_controller_update(api, user_agent, instance, body=body)
    pprint(api_response)
except ApiException as e:
 ...
 **user_agent** | **str**| The user agent of the calling client. | 
 **instance** | **int**| The instance ID being accessed | 
 **body** | [**Body28**](Body28.md)| The updated Tgstation.Server.Api.Models.DreamDaemon settings. | [optional] 
